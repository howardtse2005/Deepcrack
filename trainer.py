...
class SegFormerTrainer(nn.Module):
    """Trainer for SegFormer using Focal Loss like other models"""
    ...
    def train_op(self, input, target):
        ...
        output_loss = self.mask_loss(pred_output.view(-1, 1), target.view(-1, 1))
        ...
        self.iter_counter += 1
        self.vis.set_step(self.iter_counter)
